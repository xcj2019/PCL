...
main (int argc, char** argv)
{
    ...
    viewer->addPointCloudPrincipalCurvatures(cloud,cloud_normals,cloud_curvatures,1,0.03,"cloud_curvatures");
//    viewer->addPointCloudPrincipalCurvatures<pcl::PointXYZ, pcl::PrincipalCurvatures>(cloud, cloud_curvatures, 1, 0.03, "cloud_curvatures")
