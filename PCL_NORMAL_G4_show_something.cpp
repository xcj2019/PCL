...
//    pcl::io::savePCDFile ("principalCurvatures.pcd", *principalCurvatures);
    ...
    {
        double  normal_x=Normals->points[i].normal_x;
        double  normal_y=Normals->points[i].normal_y;
        double  normal_z=Normals->points[i].normal_z;

        cout << "normal_x " << normal_x  << "normal_y " << normal_y  << "normal_z " << normal_z << endl;
