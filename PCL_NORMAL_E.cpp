...
//    return 0;
    ...
    pcl::visualization::PointCloudColorHandlerGenericField<pcl::PrincipalCurvatures> color_handler (*principalCurvatures, "curvature");
    if (!color_handler.isCapable ()) {
        PCL_WARN ("Cannot create curvature color handler!");
    }
    viewer.addPointCloud(*principalCurvatures,color_handler,"myCLooud");
